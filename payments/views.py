...
from .serializers import PaymentSerializer,EsewaVerificationSerializer
...
class PaymentViewSet(MultiLookupMixin, viewsets.ModelViewSet):
    ...
    search_fields = ['order__id', 'transaction_id', 'method', 'payment_status', 'card_last4', 'card_brand']
