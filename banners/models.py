...
class Banner(BaseModel):
    ...
    image = models.ImageField(upload_to='banners/', null=True, blank=True, verbose_name="Banner Image")
    ...
    display_location = models.CharField(max_length=50, choices=DISPLAY_LOCATION_CHOICES, default='homepage__header')
